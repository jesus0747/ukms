 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fl=1024,pl=30*24*60*60*1e3;class _l{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new ml(t),this._heartbeatsCachePromise=this._storage.read().then(s=>(this._heartbeatsCache=s,s))}async triggerHeartbeat(){var e,t;try{const i=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),r=Di();return((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===r||this._heartbeatsCache.heartbeats.some(o=>o.date===r)?void 0:(this._heartbeatsCache.heartbeats.push({date:r,agent:i}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(o=>{const a=new Date(o.date).valueOf();return Date.now()-a<=pl}),this._storage.overwrite(this._heartbeatsCache))}catch(s){ie.warn(s)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=Di(),{heartbeatsToSend:s,unsentEntries:i}=gl(this._heartbeatsCache.heartbeats),r=sn(JSON.stringify({version:2,heartbeats:s}));return this._heartbeatsCache.lastSentHeartbeatDate=t,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),r}catch(t){return ie.warn(t),""}}}function Di(){return new Date().toISOString().substring(0,10)}function gl(n,e=fl){const t=[];let s=n.slice();for(const i of n){const r=t.find(o=>o.agent===i.agent);if(r){if(r.dates.push(i.date),xi(t)>e){r.dates.pop();break}}else if(t.push({agent:i.agent,dates:[i.date]}),xi(t)>e){t.pop();break}s=s.slice(1)}return{heartbeatsToSend:t,unsentEntries:s}}class ml{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return ec()?tc().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await dl(this.app);return t!=null&&t.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){var t;if(await this._canUseIndexedDBPromise){const i=await this.read();return Oi(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var t;if(await this._canUseIndexedDBPromise){const i=await this.read();return Oi(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function xi(n){return sn(JSON.stringify({version:2,heartbeats:n})).length}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mo{constructor(e){this.allowedEvents_=e,this.listeners_={},f(Array.isArray(e)&&e.length>0,"Requires a non-empty array")}trigger(e,...t){if(Array.isArray(this.listeners_[e])){const s=[...this.listeners_[e]];for(let i=0;i<s.length;i++)s[i].callback.apply(s[i].context,t)}}on(e,t,s){this.validateEventType_(e),this.listeners_[e]=this.listeners_[e]||[],this.listeners_[e].push({callback:t,context:s});const i=this.getInitialEvent(e);i&&t.apply(s,i)}off(e,t,s){this.validateEventType_(e);const i=this.listeners_[e]||[];for(let r=0;r<i.length;r++)if(i[r].callback===t&&(!s||s===i[r].context)){i.splice(r,1);return}}validateEventType_(e){f(this.allowedEvents_.find(t=>t===e),"Unknown event: "+e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class un extends mo{constructor(){super(["online"]),this.online_=!0,typeof window<"u"&&typeof window.addEventListener<"u"&&!Ss()&&(window.addEventListener("online",()=>{this.online_||(this.online_=!0,this.trigger("online",!0))},!1),window.addEventListener("offline",()=>{this.online_&&(this.online_=!1,this.trigger("online",!1))},!1))}static getInstance(){return new un}getInitialEvent(e){return f(e==="online","Unknown event type: "+e),[this.online_]}currentlyOnline(){return this.online_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ls extends mo{constructor(){super(["visible"]);let e,t;typeof document<"u"&&typeof document.addEventListener<"u"&&(typeof document.hidden<"u"?(t="visibilitychange",e="hidden"):typeof document.mozHidden<"u"?(t="mozvisibilitychange",e="mozHidden"):typeof document.msHidden<"u"?(t="msvisibilitychange",e="msHidden"):typeof document.webkitHidden<"u"&&(t="webkitvisibilitychange",e="webkitHidden")),this.visible_=!0,t&&document.addEventListener(t,()=>{const s=!document[e];s!==this.visible_&&(this.visible_=s,this.trigger("visible",s))},!1)}static getInstance(){return new Ls}getInitialEvent(e){return f(e==="visible","Unknown event type: "+e),[this.visible_]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ku=!0;function O(n,e=null){if(n===null)return g.EMPTY_NODE;if(typeof n=="object"&&".priority"in n&&(e=n[".priority"]),f(e===null||typeof e=="string"||typeof e=="number"||typeof e=="object"&&".sv"in e,"Invalid priority type found: "+typeof e),typeof n=="object"&&".value"in n&&n[".value"]!==null&&(n=n[".value"]),typeof n!="object"||".sv"in n){const t=n;return new x(t,O(e))}if(!(n instanceof Array)&&ku){const t=[];let s=!1;if(F(n,(o,a)=>{if(o.substring(0,1)!=="."){const c=O(a);c.isEmpty()||(s=s||!c.getPriority().isEmpty(),t.push(new I(o,c)))}}),t.length===0)return g.EMPTY_NODE;const r=hn(t,Iu,o=>o.name,Fs);if(s){const o=hn(t,k.getCompare());return new g(r,O(e),new Z({".priority":o},{".priority":k}))}else return new g(r,O(e),Z.Default)}else{let t=g.EMPTY_NODE;return F(n,(s,i)=>{if(J(n,s)&&s.substring(0,1)!=="."){const r=O(i);(r.isLeafNode()||!r.isEmpty())&&(t=t.updateImmediateChild(s,r))}}),t.updatePriority(O(e))}}Eu(O);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vu{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function $u(n,e,t,s){const i=[],r=[];return e.forEach(o=>{o.type==="child_changed"&&n.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&r.push(Ru(o.childName,o.snapshotNode))}),gt(n,i,"child_removed",e,s,t),gt(n,i,"child_added",e,s,t),gt(n,i,"child_moved",r,s,t),gt(n,i,"child_changed",e,s,t),gt(n,i,"value",e,s,t),i}function gt(n,e,t,s,i,r){const o=s.filter(a=>a.type===t);o.sort((a,c)=>Gu(n,a,c)),o.forEach(a=>{const c=ju(n,a,r);i.forEach(l=>{l.respondsTo(a.type)&&e.push(l.createEvent(c,n.query_))})})}function ju(n,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,n.index_)),e}function Gu(n,e,t){if(e.childName==null||t.childName==null)throw rt("Should only compare child_ events.");const s=new I(e.childName,e.snapshotNode),i=new I(t.childName,t.snapshotNode);return n.index_.compare(s,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lh(n){return{filter:n}}function uh(n,e){f(e.eventCache.getNode().isIndexed(n.filter.getIndex()),"Event snap not indexed"),f(e.serverCache.getNode().isIndexed(n.filter.getIndex()),"Server snap not indexed")}function hh(n,e,t,s,i){const r=new ah;let o,a;if(t.type===q.OVERWRITE){const l=t;l.source.fromUser?o=_s(n,e,l.path,l.snap,s,i,r):(f(l.source.fromServer,"Unknown source."),a=l.source.tagged||e.serverCache.isFiltered()&&!v(l.path),o=yn(n,e,l.path,l.snap,s,i,a,r))}else if(t.type===q.MERGE){const l=t;l.source.fromUser?o=fh(n,e,l.path,l.children,s,i,r):(f(l.source.fromServer,"Unknown source."),a=l.source.tagged||e.serverCache.isFiltered(),o=gs(n,e,l.path,l.children,s,i,a,r))}else if(t.type===q.ACK_USER_WRITE){const l=t;l.revert?o=gh(n,e,l.path,s,i,r):o=ph(n,e,l.path,l.affectedTree,s,i,r)}else if(t.type===q.LISTEN_COMPLETE)o=_h(n,e,t.path,s,r);else throw rt("Unknown operation type: "+t.type);const c=r.getChanges();return dh(e,o,c),{viewCache:o,changes:c}}function dh(n,e,t){const s=e.eventCache;if(s.isFullyInitialized()){const i=s.getNode().isLeafNode()||s.getNode().isEmpty(),r=_n(n);(t.length>0||!n.eventCache.isFullyInitialized()||i&&!s.getNode().equals(r)||!s.getNode().getPriority().equals(r.getPriority()))&&t.push(Ao(_n(e)))}}function Lo(n,e,t,s,i,r){const o=e.eventCache;if(mn(s,t)!=null)return e;{let a,c;if(v(t))if(f(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const l=He(e),h=l instanceof g?l:g.EMPTY_NODE,u=js(s,h);a=n.filter.updateFullNode(e.eventCache.getNode(),u,r)}else{const l=gn(s,He(e));a=n.filter.updateFullNode(e.eventCache.getNode(),l,r)}else{const l=w(t);if(l===".priority"){f(Se(t)===1,"Can't have a priority with additional path components");const h=o.getNode();c=e.serverCache.getNode();const u=sr(s,t,h,c);u!=null?a=n.filter.updatePriority(h,u):a=o.getNode()}else{const h=A(t);let u;if(o.isCompleteForChild(l)){c=e.serverCache.getNode();const d=sr(s,t,o.getNode(),c);d!=null?u=o.getNode().getImmediateChild(l).updateChild(h,d):u=o.getNode().getImmediateChild(l)}else u=Gs(s,l,e.serverCache);u!=null?a=n.filter.updateChild(o.getNode(),l,u,h,i,r):a=o.getNode()}}return It(e,a,o.isFullyInitialized()||v(t),n.filter.filtersNodes())}}function yn(n,e,t,s,i,r,o,a){const c=e.serverCache;let l;const h=o?n.filter:n.filter.getIndexedFilter();if(v(t))l=h.updateFullNode(c.getNode(),s,null);else if(h.filtersNodes()&&!c.isFiltered()){const p=c.getNode().updateChild(t,s);l=h.updateFullNode(c.getNode(),p,null)}else{const p=w(t);if(!c.isCompleteForPath(t)&&Se(t)>1)return e;const _=A(t),P=c.getNode().getImmediateChild(p).updateChild(_,s);p===".priority"?l=h.updatePriority(c.getNode(),P):l=h.updateChild(c.getNode(),p,P,_,Mo,null)}const u=No(e,l,c.isFullyInitialized()||v(t),h.filtersNodes()),d=new qs(i,u,r);return Lo(n,u,t,i,d,a)}function _s(n,e,t,s,i,r,o){const a=e.eventCache;let c,l;const h=new qs(i,e,r);if(v(t))l=n.filter.updateFullNode(e.eventCache.getNode(),s,o),c=It(e,l,!0,n.filter.filtersNodes());else{const u=w(t);if(u===".priority")l=n.filter.updatePriority(e.eventCache.getNode(),s),c=It(e,l,a.isFullyInitialized(),a.isFiltered());else{const d=A(t),p=a.getNode().getImmediateChild(u);let _;if(v(d))_=s;else{const C=h.getCompleteChild(u);C!=null?Ms(d)===".priority"&&C.getChild(yo(d)).isEmpty()?_=C:_=C.updateChild(d,s):_=g.EMPTY_NODE}if(p.equals(_))c=e;else{const C=n.filter.updateChild(a.getNode(),u,_,d,h,o);c=It(e,C,a.isFullyInitialized(),n.filter.filtersNodes())}}}return c}function ir(n,e){return n.eventCache.isCompleteForChild(e)}function fh(n,e,t,s,i,r,o){let a=e;return s.foreach((c,l)=>{const h=R(t,c);ir(e,w(h))&&(a=_s(n,a,h,l,i,r,o))}),s.foreach((c,l)=>{const h=R(t,c);ir(e,w(h))||(a=_s(n,a,h,l,i,r,o))}),a}function rr(n,e,t){return t.foreach((s,i)=>{e=e.updateChild(s,i)}),e}function gs(n,e,t,s,i,r,o,a){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let c=e,l;v(t)?l=s:l=new S(null).setTree(t,s);const h=e.serverCache.getNode();return l.children.inorderTraversal((u,d)=>{if(h.hasChild(u)){const p=e.serverCache.getNode().getImmediateChild(u),_=rr(n,p,d);c=yn(n,c,new b(u),_,i,r,o,a)}}),l.children.inorderTraversal((u,d)=>{const p=!e.serverCache.isCompleteForChild(u)&&d.value===null;if(!h.hasChild(u)&&!p){const _=e.serverCache.getNode().getImmediateChild(u),C=rr(n,_,d);c=yn(n,c,new b(u),C,i,r,o,a)}}),c}function ph(n,e,t,s,i,r,o){if(mn(i,t)!=null)return e;const a=e.serverCache.isFiltered(),c=e.serverCache;if(s.value!=null){if(v(t)&&c.isFullyInitialized()||c.isCompleteForPath(t))return yn(n,e,t,c.getNode().getChild(t),i,r,a,o);if(v(t)){let l=new S(null);return c.getNode().forEachChild(Le,(h,u)=>{l=l.set(new b(h),u)}),gs(n,e,t,l,i,r,a,o)}else return e}else{let l=new S(null);return s.foreach((h,u)=>{const d=R(t,h);c.isCompleteForPath(d)&&(l=l.set(h,c.getNode().getChild(d)))}),gs(n,e,t,l,i,r,a,o)}}function _h(n,e,t,s,i){const r=e.serverCache,o=No(e,r.getNode(),r.isFullyInitialized()||v(t),r.isFiltered());return Lo(n,o,t,s,Mo,i)}function gh(n,e,t,s,i,r){let o;if(mn(s,t)!=null)return e;{const a=new qs(s,e,i),c=e.eventCache.getNode();let l;if(v(t)||w(t)===".priority"){let h;if(e.serverCache.isFullyInitialized())h=gn(s,He(e));else{const u=e.serverCache.getNode();f(u instanceof g,"serverChildren would be complete if leaf node"),h=js(s,u)}h=h,l=n.filter.updateFullNode(c,h,r)}else{const h=w(t);let u=Gs(s,h,e.serverCache);u==null&&e.serverCache.isCompleteForChild(h)&&(u=c.getImmediateChild(h)),u!=null?l=n.filter.updateChild(c,h,u,A(t),a,r):e.eventCache.getNode().hasChild(h)?l=n.filter.updateChild(c,h,g.EMPTY_NODE,A(t),a,r):l=c,l.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=gn(s,He(e)),o.isLeafNode()&&(l=n.filter.updateFullNode(l,o,r)))}return o=e.serverCache.isFullyInitialized()||mn(s,E())!=null,It(e,l,o,n.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gd(n){let e="";const t=n.split("/");for(let s=0;s<t.length;s++)if(t[s].length>0){let i=t[s];try{i=decodeURIComponent(i.replace(/\+/g," "))}catch{}e+="/"+i}return e}function md(n){const e={};n.charAt(0)==="?"&&(n=n.substring(1));for(const t of n.split("&")){if(t.length===0)continue;const s=t.split("=");s.length===2?e[decodeURIComponent(s[0])]=decodeURIComponent(s[1]):B(`Invalid query segment '${t}' in query '${n}'`)}return e}const fr=function(n,e){const t=yd(n),s=t.namespace;t.domain==="firebase.com"&&re(t.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!s||s==="undefined")&&t.domain!=="localhost"&&re("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),t.secure||Al();const i=t.scheme==="ws"||t.scheme==="wss";return{repoInfo:new co(t.host,t.secure,s,i,e,"",s!==t.subdomain),path:new b(t.pathString)}},yd=function(n){let e="",t="",s="",i="",r="",o=!0,a="https",c=443;if(typeof n=="string"){let l=n.indexOf("//");l>=0&&(a=n.substring(0,l-1),n=n.substring(l+2));let h=n.indexOf("/");h===-1&&(h=n.length);let u=n.indexOf("?");u===-1&&(u=n.length),e=n.substring(0,Math.min(h,u)),h<u&&(i=gd(n.substring(h,u)));const d=md(n.substring(Math.min(n.length,u)));l=e.indexOf(":"),l>=0?(o=a==="https"||a==="wss",c=parseInt(e.substring(l+1),10)):l=e.length;const p=e.slice(0,l);if(p.toLowerCase()==="localhost")t="localhost";else if(p.split(".").length<=2)t=p;else{const _=e.indexOf(".");s=e.substring(0,_).toLowerCase(),t=e.substring(_+1),r=s}"ns"in d&&(r=d.ns)}return{host:e,port:c,domain:t,subdomain:s,secure:o,scheme:a,pathString:i,namespace:r}};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ct(n){if(n)try{const e=new Date(Number(n));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function Kd(n,e=!1){const t=V(n),s=await t.getIdToken(e),i=mi(s);m(i&&i.exp&&i.auth_time&&i.iat,t.auth,"internal-error");const r=typeof i.firebase=="object"?i.firebase:void 0,o=r==null?void 0:r.sign_in_provider;return{claims:i,token:s,authTime:Ct(es(i.auth_time)),issuedAtTime:Ct(es(i.iat)),expirationTime:Ct(es(i.exp)),signInProvider:o||null,signInSecondFactor:(r==null?void 0:r.sign_in_second_factor)||null}}function es(n){return Number(n)*1e3}function mi(n){const[e,t,s]=n.split(".");if(e===void 0||t===void 0||s===void 0)return Zt("JWT malformed, contained fewer than 3 sections"),null;try{const i=rn(t);return i?JSON.parse(i):(Zt("Failed to decode base64 JWT payload"),null)}catch(i){return Zt("Caught error parsing JWT payload as JSON",i==null?void 0:i.toString()),null}}function gr(n){const e=mi(n);return m(e,"internal-error"),m(typeof e.exp<"u","internal-error"),m(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ye{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){m(e.idToken,"internal-error"),m(typeof e.idToken<"u","internal-error"),m(typeof e.refreshToken<"u","internal-error");const t="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):gr(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}updateFromIdToken(e){m(e.length!==0,"internal-error");const t=gr(e);this.updateTokensAndExpiration(e,null,t)}async getToken(e,t=!1){return!t&&this.accessToken&&!this.isExpired?this.accessToken:(m(this.refreshToken,e,"user-token-expired"),this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:s,refreshToken:i,expiresIn:r}=await Zd(e,t);this.updateTokensAndExpiration(s,i,Number(r))}updateTokensAndExpiration(e,t,s){this.refreshToken=t||null,this.accessToken=e||null,this.expirationTime=Date.now()+s*1e3}static fromJSON(e,t){const{refreshToken:s,accessToken:i,expirationTime:r}=t,o=new Ye;return s&&(m(typeof s=="string","internal-error",{appName:e}),o.refreshToken=s),i&&(m(typeof i=="string","internal-error",{appName:e}),o.accessToken=i),r&&(m(typeof r=="number","internal-error",{appName:e}),o.expirationTime=r),o}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new Ye,this.toJSON())}_performRefresh(){return ee("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mr=new Map;function ne(n){ae(n instanceof Function,"Expected a class definition");let e=mr.get(n);return e?(ae(e instanceof n,"Instance stored in cache mismatched with class"),e):(e=new n,mr.set(n,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vr(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(va(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(ga(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(wa(e))return"Blackberry";if(Ea(e))return"Webos";if(ma(e))return"Safari";if((e.includes("chrome/")||ya(e))&&!e.includes("edge/"))return"Chrome";if(Ia(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,s=n.match(t);if((s==null?void 0:s.length)===2)return s[1]}return"Other"}function ga(n=W()){return/firefox\//i.test(n)}function ma(n=W()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function ya(n=W()){return/crios\//i.test(n)}function va(n=W()){return/iemobile/i.test(n)}function Ia(n=W()){return/android/i.test(n)}function wa(n=W()){return/blackberry/i.test(n)}function Ea(n=W()){return/webos/i.test(n)}function yi(n=W()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function tf(n=W()){var e;return yi(n)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function nf(){return Za()&&document.documentMode===10}function Ca(n=W()){return yi(n)||Ia(n)||Ea(n)||wa(n)||/windows phone/i.test(n)||va(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function rf(n,e={}){return dt(n,"GET","/v2/passwordPolicy",gi(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ff(n,e){const t=Ns(n,"auth");if(t.isInitialized()){const i=t.getImmediate(),r=t.getOptions();if(an(r,e??{}))return i;oe(i,"already-initialized")}return t.initialize({options:e})}function pf(n,e){const t=(e==null?void 0:e.persistence)||[],s=(Array.isArray(t)?t:[t]).map(ne);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(s,e==null?void 0:e.popupRedirectResolver)}function _f(n,e,t){const s=vi(n);m(s._canInitEmulator,s,"emulator-config-failed"),m(/^https?:\/\//.test(e),s,"invalid-emulator-scheme");const i=!1,r=Ta(e),{host:o,port:a}=gf(e),c=a===null?"":`:${a}`;s.config.emulator={url:`${r}//${o}${c}/`},s.settings.appVerificationDisabledForTesting=!0,s.emulatorConfig=Object.freeze({host:o,port:a,protocol:r.replace(":",""),options:Object.freeze({disableWarnings:i})}),mf()}function Ta(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function gf(n){const e=Ta(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const s=t[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(s);if(i){const r=i[1];return{host:r,port:wr(s.substr(r.length+1))}}else{const[r,o]=s.split(":");return{host:r,port:wr(o)}}}function wr(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function mf(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Je(n,e){return Gd(n,"POST","/v1/accounts:signInWithIdp",gi(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _p={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},gp=500,mp=600,yp="_blank",vp="http://localhost";class Ar{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function Ip(n,e,t,s=gp,i=mp){const r=Math.max((window.screen.availHeight-i)/2,0).toString(),o=Math.max((window.screen.availWidth-s)/2,0).toString();let a="";const c=Object.assign(Object.assign({},_p),{width:s.toString(),height:i.toString(),top:r,left:o}),l=W().toLowerCase();t&&(a=ya(l)?yp:t),ga(l)&&(e=e||vp,c.scrollbars="yes");const h=Object.entries(c).reduce((d,[p,_])=>`${d}${p}=${_},`,"");if(tf(l)&&a!=="_self")return wp(e||"",a),new Ar(null);const u=window.open(e||"",a,h);m(u,n,"popup-blocked");try{u.focus()}catch{}return new Ar(u)}function wp(n,e){const t=document.createElement("a");t.href=n,t.target=e;const s=document.createEvent("MouseEvent");s.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),t.dispatchEvent(s)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ts="webStorageSupport";class Sp{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Oa,this._completeRedirectFn=Qf,this._overrideRedirectResult=zf}async _openPopup(e,t,s,i){var r;ae((r=this.eventManagers[e._key()])===null||r===void 0?void 0:r.manager,"_initialize() not called before _openPopup()");const o=await kr(e,t,s,ws(),i);return Ip(e,o,wi())}async _openRedirect(e,t,s,i){await this._originValidation(e);const r=await kr(e,t,s,ws(),i);return Nf(r),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:i,promise:r}=this.eventManagers[t];return i?Promise.resolve(i):(ae(r,"If manager is not set, promise should be"),r)}const s=this.initAndGetManager(e);return this.eventManagers[t]={promise:s},s.catch(()=>{delete this.eventManagers[t]}),s}async initAndGetManager(e){const t=await pp(e),s=new Xf(e);return t.register("authEvent",i=>(m(i==null?void 0:i.authEvent,e,"invalid-auth-event"),{status:s.onEvent(i.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:s},this.iframes[e._key()]=t,s}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(ts,{type:ts},i=>{var r;const o=(r=i==null?void 0:i[0])===null||r===void 0?void 0:r[ts];o!==void 0&&t(!!o),oe(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=sp(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Ca()||ma()||yi()}}const Ap=Sp;var Nr="@firebase/auth",Rr="1.7.9";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pp=5*60,Op=Ur("authIdTokenMaxAge")||Pp;let Pr=null;const Dp=n=>async e=>{const t=e&&await e.getIdTokenResult(),s=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(s&&s>Op)return;const i=t==null?void 0:t.token;Pr!==i&&(Pr=i,await fetch(n,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))};function xp(n=Gr()){const e=Ns(n,"auth");if(e.isInitialized())return e.getImmediate();const t=ff(n,{popupRedirectResolver:Ap,persistence:[Uf,Sf,Oa]}),s=Ur("authTokenSyncURL");if(s&&typeof isSecureContext=="boolean"&&isSecureContext){const r=new URL(s,location.origin);if(location.origin===r.origin){const o=Dp(r.toString());Cf(t,o,()=>o(t.currentUser)),Ef(t,a=>o(a))}}const i=Lr("auth");return i&&_f(t,`http://${i}`),t}function Mp(){var n,e;return(e=(n=document.getElementsByTagName("head"))===null||n===void 0?void 0:n[0])!==null&&e!==void 0?e:document}lf({loadJS(n){return new Promise((e,t)=>{const s=document.createElement("script");s.setAttribute("src",n),s.onload=e,s.onerror=i=>{const r=Y("internal-error");r.customData=i,t(r)},s.type="text/javascript",s.charset="UTF-8",Mp().appendChild(s)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});Rp("Browser");class Lp{constructor(){this.app=null,this.db=null,this.firebaseAuth=null,this.currentUser=null,this.auth={signIn:async(e,t)=>{const s=this.getDB(),i=y(s,"users"),r=de(i,ue("netId"),he(e)),o=await N(r);if(!o.exists())throw new Error("Invalid credentials");const a=Object.values(o.val())[0],c=Object.keys(o.val())[0],l=await this.hashPassword(t);if(a.passwordHash!==l)throw new Error("Invalid credentials");if(!a.active)throw new Error("User account is disabled");return this.currentUser={id:c,netId:a.netId,fullName:a.fullName,email:a.email,role:a.role,active:a.active,campusIds:a.campusIds||[],temporaryPassword:a.temporaryPassword||!1,createdAt:a.createdAt,updatedAt:a.updatedAt},{user:this.currentUser}},signOut:async()=>{this.currentUser=null},createUser:async(e,t,s)=>{const i=this.getDB(),r=await this.hashPassword(t),o=le(y(i,"users")),c={id:o.key,netId:e,email:s,fullName:"",role:"basic_user",active:!0,campusIds:[],temporaryPassword:!0,createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()};return await K(o,{...c,passwordHash:r}),c},updatePassword:async(e,t)=>{const s=this.getDB(),i=await this.hashPassword(t);await Oe(y(s,`users/${e}`),{passwordHash:i,temporaryPassword:!1,updatedAt:new Date().toISOString()})},getCurrentUser:async()=>this.currentUser},this.users={getAll:async()=>{const e=this.getDB(),t=await N(y(e,"users"));if(!t.exists())return[];const s=[];return t.forEach(i=>{const r=i.val();s.push({id:i.key,netId:r.netId,fullName:r.fullName,email:r.email,role:r.role,active:r.active,campusIds:r.campusIds||[],temporaryPassword:r.temporaryPassword||!1,createdAt:r.createdAt,updatedAt:r.updatedAt})}),s},getById:async e=>{const t=this.getDB(),s=await N(y(t,`users/${e}`));if(!s.exists())return null;const i=s.val();return{id:e,netId:i.netId,fullName:i.fullName,email:i.email,role:i.role,active:i.active,campusIds:i.campusIds||[],temporaryPassword:i.temporaryPassword||!1,createdAt:i.createdAt,updatedAt:i.updatedAt}},getByNetId:async e=>{const t=this.getDB(),s=y(t,"users"),i=de(s,ue("netId"),he(e)),r=await N(i);if(!r.exists())return null;const o=Object.keys(r.val())[0],a=Object.values(r.val())[0];return{id:o,netId:a.netId,fullName:a.fullName,email:a.email,role:a.role,active:a.active,campusIds:a.campusIds||[],temporaryPassword:a.temporaryPassword||!1,createdAt:a.createdAt,updatedAt:a.updatedAt}},create:async e=>{const t=this.getDB(),s=le(y(t,"users")),r={id:s.key,netId:e.netId,fullName:e.fullName||"",email:e.email||"",role:e.role||"basic_user",active:e.active!==void 0?e.active:!0,campusIds:e.campusIds||[],temporaryPassword:e.temporaryPassword!==void 0?e.temporaryPassword:!0,createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()};return await K(s,r),r},update:async(e,t)=>{const s=this.getDB();await Oe(y(s,`users/${e}`),{...t,updatedAt:new Date().toISOString()})},delete:async e=>{const t=this.getDB();await mt(y(t,`users/${e}`))},count:async()=>(await this.users.getAll()).length},this.campuses={getAll:async()=>{const e=this.getDB(),t=await N(y(e,"campuses"));if(!t.exists())return[];const s=[];return t.forEach(i=>{const r=i.val();s.push({id:i.key,name:r.name,code:r.code,address:r.address,active:r.active,createdAt:r.createdAt,updatedAt:r.updatedAt})}),s},getById:async e=>{const t=this.getDB(),s=await N(y(t,`campuses/${e}`));if(!s.exists())return null;const i=s.val();return{id:e,name:i.name,code:i.code,address:i.address,active:i.active,createdAt:i.createdAt,updatedAt:i.updatedAt}},create:async e=>{const t=this.getDB(),s=le(y(t,"campuses")),r={id:s.key,name:e.name,code:e.code,address:e.address||"",active:e.active!==void 0?e.active:!0,createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()};return await K(s,r),r},update:async(e,t)=>{const s=this.getDB();await Oe(y(s,`campuses/${e}`),{...t,updatedAt:new Date().toISOString()})},delete:async e=>{const t=this.getDB();await mt(y(t,`campuses/${e}`))}},this.buildings={getAll:async()=>{const e=this.getDB(),t=await N(y(e,"buildings"));if(!t.exists())return[];const s=[];return t.forEach(i=>{const r=i.val();s.push({id:i.key,name:r.name,code:r.code,campusId:r.campusId,address:r.address,active:r.active,createdAt:r.createdAt,updatedAt:r.updatedAt})}),s},getByCampusId:async e=>{const t=this.getDB(),s=y(t,"buildings"),i=de(s,ue("campusId"),he(e)),r=await N(i);if(!r.exists())return[];const o=[];return r.forEach(a=>{const c=a.val();o.push({id:a.key,name:c.name,code:c.code,campusId:c.campusId,address:c.address,active:c.active,createdAt:c.createdAt,updatedAt:c.updatedAt})}),o},getById:async e=>{const t=this.getDB(),s=await N(y(t,`buildings/${e}`));if(!s.exists())return null;const i=s.val();return{id:e,name:i.name,code:i.code,campusId:i.campusId,address:i.address,active:i.active,createdAt:i.createdAt,updatedAt:i.updatedAt}},create:async e=>{const t=this.getDB(),s=le(y(t,"buildings")),r={id:s.key,name:e.name,code:e.code,campusId:e.campusId,address:e.address||"",active:e.active!==void 0?e.active:!0,createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()};return await K(s,r),r},update:async(e,t)=>{const s=this.getDB();await Oe(y(s,`buildings/${e}`),{...t,updatedAt:new Date().toISOString()})},delete:async e=>{const t=this.getDB();await mt(y(t,`buildings/${e}`))}},this.keySystems={getAll:async()=>{const e=this.getDB(),t=await N(y(e,"key_systems"));if(!t.exists())return[];const s=[];return t.forEach(i=>{const r=i.val();s.push({id:i.key,name:r.name,brand:r.brand,campusId:r.campusId,description:r.description,active:r.active,createdAt:r.createdAt,updatedAt:r.updatedAt})}),s},getById:async e=>{const t=this.getDB(),s=await N(y(t,`key_systems/${e}`));if(!s.exists())return null;const i=s.val();return{id:e,name:i.name,brand:i.brand,campusId:i.campusId,description:i.description,active:i.active,createdAt:i.createdAt,updatedAt:i.updatedAt}},create:async e=>{const t=this.getDB(),s=le(y(t,"key_systems")),r={id:s.key,name:e.name,brand:e.brand,campusId:e.campusId,description:e.description||"",active:e.active!==void 0?e.active:!0,createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()};return await K(s,r),r},update:async(e,t)=>{const s=this.getDB();await Oe(y(s,`key_systems/${e}`),{...t,updatedAt:new Date().toISOString()})},delete:async e=>{const t=this.getDB();await mt(y(t,`key_systems/${e}`))}},this.keys={getAll:async()=>{const e=this.getDB(),t=await N(y(e,"keys"));if(!t.exists())return[];const s=[];return t.forEach(i=>{const r=i.val();s.push({id:i.key,keyNumber:r.keyNumber,keySystemId:r.keySystemId,buildingId:r.buildingId,roomNumber:r.roomNumber,status:r.status,medecoKeyNumber:r.medecoKeyNumber,medecoKeySerial:r.medecoKeySerial,medecoCardNumber:r.medecoCardNumber,notes:r.notes,createdAt:r.createdAt,updatedAt:r.updatedAt})}),s},getById:async e=>{const t=this.getDB(),s=await N(y(t,`keys/${e}`));if(!s.exists())return null;const i=s.val();return{id:e,keyNumber:i.keyNumber,keySystemId:i.keySystemId,buildingId:i.buildingId,roomNumber:i.roomNumber,status:i.status,medecoKeyNumber:i.medecoKeyNumber,medecoKeySerial:i.medecoKeySerial,medecoCardNumber:i.medecoCardNumber,notes:i.notes,createdAt:i.createdAt,updatedAt:i.updatedAt}},getBySystemId:async e=>{const t=this.getDB(),s=y(t,"keys"),i=de(s,ue("keySystemId"),he(e)),r=await N(i);if(!r.exists())return[];const o=[];return r.forEach(a=>{const c=a.val();o.push({id:a.key,keyNumber:c.keyNumber,keySystemId:c.keySystemId,buildingId:c.buildingId,roomNumber:c.roomNumber,status:c.status,medecoKeyNumber:c.medecoKeyNumber,medecoKeySerial:c.medecoKeySerial,medecoCardNumber:c.medecoCardNumber,notes:c.notes,createdAt:c.createdAt,updatedAt:c.updatedAt})}),o},getByBuildingId:async e=>{const t=this.getDB(),s=y(t,"keys"),i=de(s,ue("buildingId"),he(e)),r=await N(i);if(!r.exists())return[];const o=[];return r.forEach(a=>{const c=a.val();o.push({id:a.key,keyNumber:c.keyNumber,keySystemId:c.keySystemId,buildingId:c.buildingId,roomNumber:c.roomNumber,status:c.status,medecoKeyNumber:c.medecoKeyNumber,medecoKeySerial:c.medecoKeySerial,medecoCardNumber:c.medecoCardNumber,notes:c.notes,createdAt:c.createdAt,updatedAt:c.updatedAt})}),o},create:async e=>{const t=this.getDB(),s=le(y(t,"keys")),r={id:s.key,keyNumber:e.keyNumber,keySystemId:e.keySystemId,buildingId:e.buildingId,roomNumber:e.roomNumber||"",status:e.status||"available",medecoKeyNumber:e.medecoKeyNumber||null,medecoKeySerial:e.medecoKeySerial||null,medecoCardNumber:e.medecoCardNumber||null,notes:e.notes||"",createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()};return await K(s,r),r},update:async(e,t)=>{const s=this.getDB();await Oe(y(s,`keys/${e}`),{...t,updatedAt:new Date().toISOString()})},delete:async e=>{const t=this.getDB();await mt(y(t,`keys/${e}`))},search:async e=>{const t=await this.keys.getAll(),s=e.toLowerCase();return t.filter(i=>{var r,o,a;return i.keyNumber.toLowerCase().includes(s)||((r=i.roomNumber)==null?void 0:r.toLowerCase().includes(s))||((o=i.medecoKeyNumber)==null?void 0:o.toLowerCase().includes(s))||((a=i.notes)==null?void 0:a.toLowerCase().includes(s))})}},this.keyHistory={getAll:async()=>{const e=this.getDB(),t=await N(y(e,"key_history"));if(!t.exists())return[];const s=[];return t.forEach(i=>{const r=i.val();s.push({id:i.key,keyId:r.keyId,userId:r.userId,action:r.action,checkoutDate:r.checkoutDate,expectedReturnDate:r.expectedReturnDate,actualReturnDate:r.actualReturnDate,notes:r.notes,createdAt:r.createdAt})}),s},getByKeyId:async e=>{const t=this.getDB(),s=y(t,"key_history"),i=de(s,ue("keyId"),he(e)),r=await N(i);if(!r.exists())return[];const o=[];return r.forEach(a=>{const c=a.val();o.push({id:a.key,keyId:c.keyId,userId:c.userId,action:c.action,checkoutDate:c.checkoutDate,expectedReturnDate:c.expectedReturnDate,actualReturnDate:c.actualReturnDate,notes:c.notes,createdAt:c.createdAt})}),o},getByUserId:async e=>{const t=this.getDB(),s=y(t,"key_history"),i=de(s,ue("userId"),he(e)),r=await N(i);if(!r.exists())return[];const o=[];return r.forEach(a=>{const c=a.val();o.push({id:a.key,keyId:c.keyId,userId:c.userId,action:c.action,checkoutDate:c.checkoutDate,expectedReturnDate:c.expectedReturnDate,actualReturnDate:c.actualReturnDate,notes:c.notes,createdAt:c.createdAt})}),o},getActiveCheckouts:async()=>(await this.keyHistory.getAll()).filter(t=>t.action==="checkout"&&!t.actualReturnDate),getById:async e=>{const t=this.getDB(),s=await N(y(t,`key_history/${e}`));if(!s.exists())return null;const i=s.val();return{id:e,keyId:i.keyId,userId:i.userId,action:i.action,checkoutDate:i.checkoutDate,expectedReturnDate:i.expectedReturnDate,actualReturnDate:i.actualReturnDate,notes:i.notes,createdAt:i.createdAt}},create:async e=>{const t=this.getDB(),s=le(y(t,"key_history")),r={id:s.key,keyId:e.keyId,userId:e.userId,action:e.action,checkoutDate:e.checkoutDate||null,expectedReturnDate:e.expectedReturnDate||null,actualReturnDate:e.actualReturnDate||null,notes:e.notes||"",createdAt:new Date().toISOString()};return await K(s,r),r},update:async(e,t)=>{const s=this.getDB();await Oe(y(s,`key_history/${e}`),t)}},this.auditLogs={getAll:async()=>{const e=this.getDB(),t=await N(y(e,"audit_logs"));if(!t.exists())return[];const s=[];return t.forEach(i=>{const r=i.val();s.push({id:i.key,userId:r.userId,action:r.action,entityType:r.entityType,entityId:r.entityId,description:r.description,metadata:r.metadata,createdAt:r.createdAt})}),s},getByUserId:async e=>{const t=this.getDB(),s=y(t,"audit_logs"),i=de(s,ue("userId"),he(e)),r=await N(i);if(!r.exists())return[];const o=[];return r.forEach(a=>{const c=a.val();o.push({id:a.key,userId:c.userId,action:c.action,entityType:c.entityType,entityId:c.entityId,description:c.description,metadata:c.metadata,createdAt:c.createdAt})}),o},create:async e=>{const t=this.getDB(),s=le(y(t,"audit_logs")),r={id:s.key,userId:e.userId,action:e.action,entityType:e.entityType,entityId:e.entityId||null,description:e.description,metadata:e.metadata||null,createdAt:new Date().toISOString()};return await K(s,r),r}},this.backup={export:async()=>{const e=this.getDB();return(await N(y(e))).val()||{}},import:async e=>{const t=this.getDB();await K(y(t),e)}}}async initialize(e){const{apiKey:t,authDomain:s,databaseURL:i,projectId:r,storageBucket:o,messagingSenderId:a,appId:c}=e;if(!t||!s||!i||!r)throw new Error("Firebase requires apiKey, authDomain, databaseURL, and projectId");this.app=jr({apiKey:t,authDomain:s,databaseURL:i,projectId:r,storageBucket:o,messagingSenderId:a,appId:c}),this.db=Md(this.app),this.firebaseAuth=xp(this.app)}getDB(){if(!this.db)throw new Error("Firebase not initialized");return this.db}getAuth(){if(!this.firebaseAuth)throw new Error("Firebase auth not initialized");return this.firebaseAuth}async hashPassword(e){const s=new TextEncoder().encode(e),i=await crypto.subtle.digest("SHA-256",s);return Array.from(new Uint8Array(i)).map(r=>r.toString(16).padStart(2,"0")).join("")}}export{Lp as FirebaseAdapter};
